...
from app.components.styling import render_info_banner, render_section_card, render_warning_banner
...
def render() -> None:
    st.markdown(
        ...
        <div class='page-header'>
            <h1>Heart Disease & PCOS - Association Study</h1>
    ...
    cohort_summary = pd.DataFrame(
        [
            [
                "PCOS negative",
                len(pcos_neg),
                round(pcos_neg["age_yrs"].mean(), 2),
                round(pcos_neg["systolic_bp_mmhg"].mean(), 2),
                round(pcos_neg["diastolic_bp_mmhg"].mean(), 2),
                round(pcos_neg["bmi"].mean(), 2),
                round(pcos_neg["rbs_mg_dl"].mean(), 2),
                "No",
            ],
            [
                "PCOS positive",
                len(pcos_pos),
                round(pcos_pos["age_yrs"].mean(), 2),
                round(pcos_pos["systolic_bp_mmhg"].mean(), 2),
                round(pcos_pos["diastolic_bp_mmhg"].mean(), 2),
                round(pcos_pos["bmi"].mean(), 2),
                round(pcos_pos["rbs_mg_dl"].mean(), 2),
                "No",
            ],
            [
                "Heart female reference",
                len(heart_df),
                round(heart_df["age"].mean(), 2),
                round(heart_df["resting_bp"].mean(), 2),
                "N/A",
                "N/A",
                "N/A",
                "Yes",
    ...
    bp_compare = pd.DataFrame(
        [
            [
                ...
                round(pcos_neg["systolic_bp_mmhg"].mean(), 2),
                round(pcos_neg["diastolic_bp_mmhg"].mean(), 2),
                round((pcos_neg["elevated_bp_flag"].mean() * 100), 1),
            ],
            [
                "PCOS positive",
                round(pcos_pos["systolic_bp_mmhg"].mean(), 2),
                round(pcos_pos["diastolic_bp_mmhg"].mean(), 2),
                round((pcos_pos["elevated_bp_flag"].mean() * 100), 1),
            ],
            [
                "Heart female reference",
                round(heart_df["resting_bp"].mean(), 2),
                "N/A",
                round((heart_df["high_resting_bp_flag"].mean() * 100), 1),
            ],
        ],
