...
NOTEBOOK_PATH = PROJECT_ROOT / "notebooks" / "10_metaheuristic_optimization.ipynb"
...
SEARCH_SPACE_TABLE = markdown_table(
...
ALGO_COMPARISON_TABLE = markdown_table(
...
def build_cells() -> list[dict]:
    ...
    cells.append(markdown_cell(
        ...
        ## Output Files
        """
        + "\n" + markdown_table(["Path", "Meaning"], OUTPUT_ROWS)
        + """
