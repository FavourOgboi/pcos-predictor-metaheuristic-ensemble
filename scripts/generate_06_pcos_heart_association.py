...
NOTEBOOK_PATH = PROJECT_ROOT / "notebooks" / "EDA" / "06_pcos_heart_association.ipynb"
...
def question_markdown(title: str, body: str) -> dict:
...
def interpretation_markdown(text: str) -> dict:
    return markdown_cell(
        f"""
        ### Interpretation
